...
#include <gnssRpi/Top/gnssRpiTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    gnssRpi::setupTopology(inputs);
    gnssRpi::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    gnssRpi::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
