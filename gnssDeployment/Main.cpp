...
#include <gnssDeployment/Top/gnssDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    gnssDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    gnssDeployment::TopologyState inputs;
    ...
    gnssDeployment::setupTopology(inputs);
    gnssDeployment::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    gnssDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
