// ======================================================================
// \title  gnssDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef GNSSDEPLOYMENT_GNSSDEPLOYMENTTOPOLOGY_HPP
#define GNSSDEPLOYMENT_GNSSDEPLOYMENTTOPOLOGY_HPP
// Included for access to gnssDeployment::TopologyState and gnssDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <gnssDeployment/Top/gnssDeploymentTopologyDefs.hpp>

// Remove unnecessary gnssDeployment:: qualifications
 ...
 * gnssDeployment::TopologyState see: gnssDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type gnssDeployment::TopologyState see: gnssDeploymentTopologyDefs.hpp.
 *
